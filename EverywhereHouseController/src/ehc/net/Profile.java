	...
	{		
		...
		_image.setOnClickListener( new View.OnClickListener() 
		{
			...
			public void onClick( View v ) 
			{
				...
				_dialog.setTitle( "Image" );
				_dialog.setContentView( R.layout.image_dialog );
				
				_imageDialog = ( ImageView ) _dialog.findViewById( R.id.userImageDialog );
				
				_imageDialog.setImageDrawable( _image.getDrawable() );
				 
				ImageButton _takePicture = ( ImageButton )_dialog.findViewById( R.id.takePicture );
				...
				ImageButton _choosePicture = ( ImageButton )_dialog.findViewById( R.id.choosePicture );
...
//						Toast.makeText(Profile.this, _message, Toast.LENGTH_SHORT).show();	
    ...
    private void takePicture() 
    {
		...
		imageChooserManager = new ImageChooserManager( this, ChooserType.REQUEST_CAPTURE_PICTURE, "EHCfolder", true );
    ...
    private void chooseImage() 
    {
		...
		imageChooserManager = new ImageChooserManager( this, ChooserType.REQUEST_PICK_PICTURE, "EHCfolder", true);
		imageChooserManager.setImageChooserListener( ( ImageChooserListener ) this );
		try 
		{
			filePath = imageChooserManager.choose();
	...
	{
		imageChooserManager = new ImageChooserManager( this, chooserType, "EHCfolder", true);
