...
//	private ImageView _currentImage;
    ...
    public static void takePicture() 
    {
		...
		imageChooserManager = new ImageChooserManager( _activity, ChooserType.REQUEST_CAPTURE_PICTURE, "EHCfolder", true );
    ...
    public static void chooseImage() 
    {
		...
		imageChooserManager = new ImageChooserManager( _activity, ChooserType.REQUEST_PICK_PICTURE, "EHCfolder", true );
		imageChooserManager.setImageChooserListener( ( ImageChooserListener ) _activity );
		try 
		{
			filePath = imageChooserManager.choose();			
